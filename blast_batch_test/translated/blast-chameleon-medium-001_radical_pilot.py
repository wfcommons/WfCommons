...
try:
    ...
    td_cat_ID000303 = rp.TaskDescription({
        ...
        'cores_per_rank': 1,
        'input_staging' : [
            {'source': 'pilot:///medium.fasta.0.err',
             'target': 'task:///medium.fasta.0.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.1.err',
             'target': 'task:///medium.fasta.1.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.2.err',
             'target': 'task:///medium.fasta.2.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.3.err',
             'target': 'task:///medium.fasta.3.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.4.err',
             'target': 'task:///medium.fasta.4.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.5.err',
             'target': 'task:///medium.fasta.5.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.6.err',
             'target': 'task:///medium.fasta.6.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.7.err',
             'target': 'task:///medium.fasta.7.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.8.err',
             'target': 'task:///medium.fasta.8.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.9.err',
             'target': 'task:///medium.fasta.9.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.10.err',
             'target': 'task:///medium.fasta.10.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.11.err',
             'target': 'task:///medium.fasta.11.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.12.err',
             'target': 'task:///medium.fasta.12.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.13.err',
             'target': 'task:///medium.fasta.13.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.14.err',
             'target': 'task:///medium.fasta.14.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.15.err',
             'target': 'task:///medium.fasta.15.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.16.err',
             'target': 'task:///medium.fasta.16.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.17.err',
             'target': 'task:///medium.fasta.17.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.18.err',
             'target': 'task:///medium.fasta.18.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.19.err',
             'target': 'task:///medium.fasta.19.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.20.err',
             'target': 'task:///medium.fasta.20.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.21.err',
             'target': 'task:///medium.fasta.21.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.22.err',
             'target': 'task:///medium.fasta.22.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.23.err',
             'target': 'task:///medium.fasta.23.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.24.err',
             'target': 'task:///medium.fasta.24.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.25.err',
             'target': 'task:///medium.fasta.25.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.26.err',
             'target': 'task:///medium.fasta.26.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.27.err',
             'target': 'task:///medium.fasta.27.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.28.err',
             'target': 'task:///medium.fasta.28.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.29.err',
             'target': 'task:///medium.fasta.29.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.30.err',
             'target': 'task:///medium.fasta.30.err',
             'action': rp.LINK},
            {'source': 'pilot:///medium.fasta.31.err',
