...
try:
    ...
    tasks_2 = tmgr.submit_tasks([td_cat_blast_ID000042])
    tmgr.wait_tasks([t.uid for t in tasks_2])

    # ---- Level 2: cat_ID000043 ----
    ...
    tasks_3 = tmgr.submit_tasks([td_cat_ID000043])
