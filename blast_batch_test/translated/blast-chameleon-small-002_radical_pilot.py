...
try:
    ...
    for i in range(42):
        ...
        blast_tasks.append(rp.TaskDescription({
            'uid'           : task_id,
            'executable'    : './blastall',
            'arguments'     : ['-p', 'blastn', '-d', 'nt/nt', '-i', f'small.fasta.{i}', '-o', f'small.fasta.{i}.out', '2>', f'small.fasta.{i}.err'],
            'cores_per_rank': 1,
            'input_staging' : [
    ...
    td_cat_blast_ID000042 = rp.TaskDescription({
        ...
        'arguments'     : ['None'] + [f'small.fasta.{i}.out' for i in range(40)],
        'cores_per_rank': 1,
        'input_staging' : [],
        'output_staging': [
            {'source': 'task:///None',
    ...
    td_cat_ID000043 = rp.TaskDescription({
        'uid'           : 'cat_ID000043',
        'executable'    : 'cat',
        'arguments'     : ['small.fasta.' + str(i) + '.err' for i in range(40)] + ['>', 'None.err'],
        'cores_per_rank': 1,
        'input_staging' : [],
        'output_staging': [
