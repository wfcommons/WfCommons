...
class EpigenomicsRecipe(WorkflowRecipe):
    """A Epigenomics workflow recipe class for creating synthetic workflow traces.
    ...
    @classmethod
    def from_num_tasks(cls, num_tasks: int, exclude_graphs: Set[str] = set()) -> 'EpigenomicsRecipe':
        """
        ...
        """
        return EpigenomicsRecipe(num_tasks=num_tasks, exclude_graphs=exclude_graphs)
    ...
    def build_workflow(self, workflow_name: Optional[str] = None) -> Workflow:
        """Generate a synthetic workflow trace of a Epigenomics workflow.
