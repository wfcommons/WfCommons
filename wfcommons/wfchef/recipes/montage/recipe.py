...
class MontageRecipe(WorkflowRecipe):
    """A Montage workflow recipe class for creating synthetic workflow traces.
    ...
    def __init__(self,
                 ...
                 **kwargs) -> None:
        super().__init__("Montage", data_footprint, num_tasks, exclude_graphs, runtime_factor, input_file_size_factor,
    ...
    def from_num_tasks(cls,
        ...
        :rtype: MontageRecipe
        """
        return MontageRecipe(num_tasks=num_tasks, exclude_graphs=exclude_graphs, runtime_factor=runtime_factor,
