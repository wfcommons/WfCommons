...
class SeismologyRecipe(WorkflowRecipe):
    ...
    def __init__(self,
                 ...
                 **kwargs) -> None:
        super().__init__("Seismology", data_footprint, num_tasks, exclude_graphs, runtime_factor,
    ...
    def from_num_tasks(cls,
        ...
        """
        return SeismologyRecipe(num_tasks=num_tasks, exclude_graphs=exclude_graphs, runtime_factor=runtime_factor,
    ...
    def _workflow_recipe(self) -> Dict:
        """
        Recipe for generating synthetic instances of the Seismology workflow. Recipes can be
