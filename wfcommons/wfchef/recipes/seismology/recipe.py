...
class SeismologyRecipe(WorkflowRecipe):
    ...
    @classmethod
    def from_num_tasks(cls, num_tasks: int, exclude_graphs: Set[str] = set()) -> 'SeismologyRecipe':
        """
        ...
        """
        return SeismologyRecipe(num_tasks=num_tasks, exclude_graphs=exclude_graphs)
