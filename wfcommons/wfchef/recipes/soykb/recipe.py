...
class SoykbRecipe(WorkflowRecipe):
    ...
    def __init__(self,
                 ...
                 **kwargs) -> None:
        super().__init__("Soykb", data_footprint, num_tasks, exclude_graphs, runtime_factor, input_file_size_factor,
    ...
    def from_num_tasks(cls,
        ...
        :rtype: SoykbRecipe
        """
        return SoykbRecipe(num_tasks=num_tasks, exclude_graphs=exclude_graphs, runtime_factor=runtime_factor,
    ...
    def _workflow_recipe(self) -> Dict:
        """
        Recipe for generating synthetic instances of the Soykb workflow. Recipes can be
