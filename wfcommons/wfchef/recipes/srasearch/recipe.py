...
class SrasearchRecipe(WorkflowRecipe):
    ...
    def __init__(self,
                 ...
                 **kwargs) -> None:
        super().__init__("Srasearch", data_footprint, num_tasks)
    ...
    @classmethod
    def from_num_tasks(cls, num_tasks: int, exclude_graphs: Set[str] = set()) -> 'SrasearchRecipe':
        """
        ...
        """
        return SrasearchRecipe(num_tasks=num_tasks, exclude_graphs=exclude_graphs)
    ...
    def build_workflow(self, workflow_name: Optional[str] = None) -> Workflow:
        """Generate a synthetic workflow trace of a Srasearch workflow.
