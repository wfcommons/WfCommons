...
class SrasearchRecipe(WorkflowRecipe):
    """A Srasearch workflow recipe class for creating synthetic workflow traces.
    ...
    def __init__(self,
                 ...
                 **kwargs) -> None:
        super().__init__("Srasearch", data_footprint, num_tasks, exclude_graphs, runtime_factor, input_file_size_factor,
    ...
    def from_num_tasks(cls,
        ...
        """
        Instantiate a Srasearch workflow recipe that will generate synthetic workflows up to
        ...
        :return: A Srasearch workflow recipe object that will generate synthetic workflows up
                 to the total number of tasks provided.
        :rtype: SrasearchRecipe
        """
        return SrasearchRecipe(num_tasks=num_tasks, exclude_graphs=exclude_graphs, runtime_factor=runtime_factor,
    ...
    def _workflow_recipe(self) -> Dict:
        """
        Recipe for generating synthetic traces of the Srasearch workflow. Recipes can be
