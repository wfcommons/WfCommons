...
pegasus-kickstart  -n blastall -N blastall_00000032 -R condorpool  -s blastall_00000032_output.txt=blastall_00000032_output.txt -L Blast-Benchmark -T 2021-10-16T00:21:36+00:00 ./blastall blastall blastall_00000032 --path-lock=/tmp/cores.txt.lock --path-cores=/tmp/cores.txt --percent-cpu=0.5 --cpu-work=100 --data --file-size=50 --out=blastall_00000032_output.txt
job_ec=$?
