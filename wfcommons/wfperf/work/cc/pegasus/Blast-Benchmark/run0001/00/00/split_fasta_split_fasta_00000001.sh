...
pegasus-kickstart  -n split_fasta -N split_fasta_00000001 -R condorpool  -s split_fasta_00000001_output.txt=split_fasta_00000001_output.txt -L Blast-Benchmark -T 2021-10-16T00:21:36+00:00 ./split_fasta split split_fasta_00000001 --path-lock=/tmp/cores.txt.lock --path-cores=/tmp/cores.txt --percent-cpu=0.5 --cpu-work=100 --data --file-size=50 --out=split_fasta_00000001_output.txt
job_ec=$?
