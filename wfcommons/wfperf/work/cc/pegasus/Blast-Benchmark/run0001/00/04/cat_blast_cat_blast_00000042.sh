...
pegasus-kickstart  -n cat_blast -N cat_blast_00000042 -R condorpool  -s cat_blast_00000042_output.txt=cat_blast_00000042_output.txt -L Blast-Benchmark -T 2021-10-16T00:21:36+00:00 ./cat_blast cat cat_blast_00000042 --path-lock=/tmp/cores.txt.lock --path-cores=/tmp/cores.txt --percent-cpu=0.5 --cpu-work=100 --data --file-size=50 --out=cat_blast_00000042_output.txt
job_ec=$?
